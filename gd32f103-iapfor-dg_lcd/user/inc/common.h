...
//这个打印只能从调试串口打印！！！  导光面板,调试串口是串口1
#define SerialPutString(x) Serial_PutString_Uart1((uint8_t*)(x))  //Serial_PutString((uint8_t*)(x))
...
extern uint8_t is_cpu_update_cmd ;   //是rk3399的升级吗？ 0表示调试串口，1表示通讯串口
#endif  /* _COMMON_H */
